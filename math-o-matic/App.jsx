...
export default function App() {
  ...
  /*  Challenge
        ...
        Tip: You can invoke showStates() anywhere in the top level of this component and play around with the app to familiarize yourself with the app's states and how they change 
        as the user interacts with it. Refer to the slides to get a better idea of how the app should react to the user's actions. 
